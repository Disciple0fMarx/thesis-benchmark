...
# Using the 128/8/16 architecture we refined
model = STAR(obs_len=8, pred_len=12, d_model=128, nhead=8, noise_dim=16)
model.load_state_dict(torch.load('results/checkpoints/star_best_zara1.pth', weights_only=True))
model.eval()
...
print("\n✨ STAR (Transformer) Benchmark Results:")
